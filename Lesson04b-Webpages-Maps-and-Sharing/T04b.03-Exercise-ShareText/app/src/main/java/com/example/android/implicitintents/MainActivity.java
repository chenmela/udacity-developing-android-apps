...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        String sharedText = "This is the text I want to share!";
    ...
    private void shareText(String sharedText) {
        ...
        Intent intent = ShareCompat.IntentBuilder.from(MainActivity.this).setType(mimeType).setChooserTitle(title).setText(sharedText).getIntent();
        if (intent.resolveActivity(getPackageManager()) != null) {
            startActivity(intent);
        }
    }
