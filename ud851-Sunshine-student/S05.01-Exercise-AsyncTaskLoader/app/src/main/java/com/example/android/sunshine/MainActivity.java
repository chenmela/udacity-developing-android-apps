...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private void loadWeatherData() {
        ...
        bundle.putString(LOCATION_TAG, location);

        LoaderManager loaderManager = getSupportLoaderManager();
        loaderManager.initLoader(LOADER_ID, bundle, MainActivity.this);
    }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle bundle) {
        return new AsyncTaskLoader<String[]>(MainActivity.this) {
            ...
            public String[] loadInBackground() {
                if (bundle != null) {
                    if (bundle.containsKey(LOCATION_TAG)) {
                        String location = bundle.getString(LOCATION_TAG);
